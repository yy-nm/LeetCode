// 235. Lowest Common Ancestor of a Binary Search Tree.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
class Solution {
    ...
    bool getParents(TreeNode* node, std::vector< TreeNode*>& list, int v)
    {
        ...
        if (node->val > v && node->left != nullptr) {
